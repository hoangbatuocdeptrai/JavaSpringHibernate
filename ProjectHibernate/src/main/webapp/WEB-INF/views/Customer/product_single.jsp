		...
		<div class="row">
			<div class="col-lg-6 mb-5 ftco-animate">
				<a href="images/product-1.jpg" class="image-popup"><img
					src="${pageContext.request.contextPath}/resource/Test/${b.image}" class="img-fluid"
			...
			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
				...
				<p class="price">
					<span>$ <fmt:formatNumber>${b.price}</fmt:formatNumber></span>
				</p>
				<p>${b.description} A small river named Duden flows by their place and supplies
